...
/*
n="qqoo13315163350";
salt = uin2hex(905920365);
vc="!BYF";
var nothing;
something=$.Encryption.getEncryption(n, salt, vc, nothing);
document.getElementById("see").innerText=something;
*/
function en(qqnum,qqpasswd,vc){
	var nothing;
	salt=uin2hex(qqnum);
	something=$.Encryption.getEncryption(qqpasswd,salt,vc,nothing);
	return something;
}
